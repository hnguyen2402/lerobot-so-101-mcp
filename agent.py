...
class AIAgent:
    ...
    def __init__(self, model: str = "claude-haiku-4-5-20251001", 
                 show_images: bool = False, mcp_server_ip: str = "127.0.0.1", mcp_port: int = 4001,
    ...
    async def process_with_llm(self, user_input: str) -> str:
        ...
        IF initialized == FALSE:
            ONLY permitted action:
                call get_initial_instructions
            FORBIDDEN before initialization:
                - user response
                - any other tool
                - planning
